...
-- now lets sort these isssue in above query where TRIM sorted 
-- >>>>>>> NOW ALL DONE FOR TABLE CRM(1) >>>>>>>>>>
-- NOW INSERT INTO SILVER TABLE CRM(1)
-- final query table looks like :-
...
-- =======================(Table 1 ends here) ==========/////////////////////////////////////////===========================================================
                         ...
                         -- SILVER TABLE 2
-- HERE WE WILL CLEANUP DATA INSIDE CRM TABLE 2 AND INSERT INTO SILVER LAYER------------------
...
-- =================================================
-- ALL modifation and transformation done know its time to INSERT IN SILVER TABLE 2
...
-- cleaning and inserting silver table 5--
...
-- quality check again replace bronze to silver  checked all done

-- Table 5 ends here ==========/////////////////////////////////////////===========================================================

-- SILVER TABLE 6 CLEANSING AND INSERTING --
SELECT *
...
WHERE cat != TRIM(cat) or subcat != TRIM(subcat) OR maintenance != TRIM(maintenance);             -- no extra spaces result found
 ...
 -- 'TRANSFRMATION" here not needed everything fine in this table
